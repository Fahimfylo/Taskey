...
function Modal() {
  ...
  return (
    <div className="fixed left-0 top-0 z-50 h-full w-full bg-[#333]/30 overflow-hidden">
      <form
        ref={ref as React.RefObject<HTMLFormElement>} // Type cast to match HTMLFormElement
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center justify-between bg-[#F9F9F9] p-2 rounded-md border">
            ...
            <div>
              <select
                className="bg-[#F9F9F9] p-2 rounded-md bordeer cursor-pointer"
                name="completed"
        ...
        <div className="mt-8">
          <button
            type="submit"
            className={`text-white py-2 rounded-md w-full hover:bg-blue-500 transition duration-300 ease-in-out ${
